...
describe "parser_sigs_spec.rb" do
  ...
  it ":ts_parser_included_ranges, [Parser, :uint32_p], :array_of_range" do end # TBD

  it ":ts_parser_parse, [Parser, Tree, Input.by_value], Tree" do end # TBD
  ...
  it ":ts_parser_set_cancellation_flag, [Parser, :size_p], :void" do end # TBD
  ...
  it ":ts_parser_set_logger, [Parser, Logger.by_value], :void" do end # TBD

  it ":ts_parser_logger, [Parser], Logger.by_value" do end # TBD
