...
require './gen/rusty.0.20.7/rusty_node_patch_blank.rb'
require './gen/rusty.0.20.7/rusty_query_patch_blank.rb'


require './gen/rusty.0.20.7/rusty_node_test.rb'

puts 'gen/rusty.0.20.7/rusty_node_test.rb'
init_tally()
test_node_child()
test_node_children()
...
require './gen/rusty.0.20.7/rusty_tree_test.rb'

puts 'gen/rusty.0.20.7/rusty_tree_test.rb'
init_tally()
test_tree_edit()
test_tree_cursor()
...
require './gen/rusty.0.20.7/rusty_query_test.rb'

puts 'gen/rusty.0.20.7/rusty_query_test.rb'
init_tally()
