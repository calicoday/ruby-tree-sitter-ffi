...
#     puts "err_type: #{@err_type_p.get(:uint32, 0)}"
  ...
  # :ts_query_predicates_for_pattern, [Query, :uint32, :uint32_p], QueryPredicateStep.by_ref # to patch
  ...
  # :ts_query_capture_name_for_id, [Query, :uint32, :uint32_p], :string # to patch

  # :ts_query_string_value_for_id, [Query, :uint32, :uint32_p], :string # to patch
  ...
  # :ts_query_cursor_next_capture, [QueryCursor, QueryMatch.by_ref, :uint32_p], :bool # to patch
