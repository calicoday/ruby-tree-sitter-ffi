...
require './spec/rusty-patch.0.20.7/rusty_node_patch.rb'
require './spec/rusty-patch.0.20.7/rusty_query_patch.rb'


require './spec/rusty.0.20.7/rusty_node_test.rb'

puts 'spec/rusty.0.20.7/rusty_node_test.rb'
init_tally()
test_node_child()
test_node_children()
...
require './spec/rusty.0.20.7/rusty_tree_test.rb'

puts 'spec/rusty.0.20.7/rusty_tree_test.rb'
init_tally()
test_tree_edit()
test_tree_cursor()
...
require './spec/rusty.0.20.7/rusty_query_test.rb'

puts 'spec/rusty.0.20.7/rusty_query_test.rb'
init_tally()
