...
def test_tree_edit()
    ...
    # {
        ...
        tree.edit(TreeSitterFFI::InputEdit.from_hash({
            ...
            old_end_byte: 90,
            new_end_byte: 4,
            start_position: TreeSitterFFI::Point.new(0, 3),
            old_end_position: TreeSitterFFI::Point.new(0, 90),
            new_end_position: TreeSitterFFI::Point.new(0, 4),
        }))
    ...
    # {
        ...
        tree.edit(TreeSitterFFI::InputEdit.from_hash({
            ...
            old_end_byte: 90,
            new_end_byte: 8,
            start_position: TreeSitterFFI::Point.new(0, 6),
            old_end_position: TreeSitterFFI::Point.new(0, 90),
            new_end_position: TreeSitterFFI::Point.new(0, 8),
        }))
