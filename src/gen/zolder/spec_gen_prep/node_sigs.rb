...
# 		when :ts_node_child_by_field_id then 
		...
		when :ts_node_descendant_for_point_range then '@array_node, TreeSitterFFI::Point.new, TreeSitterFFI::Point.new'
		when :ts_node_named_descendant_for_byte_range then '@number_node, 5, 7'
		when :ts_node_named_descendant_for_point_range then '@number_node, TreeSitterFFI::Point.new, TreeSitterFFI::Point.new'
