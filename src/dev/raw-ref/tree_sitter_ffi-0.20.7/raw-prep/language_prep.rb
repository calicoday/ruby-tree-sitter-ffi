    ...
    def sig_plan
      {
        ...
        ts_language_symbol_count: [nil], #patch
        ts_language_symbol_name: [nil], #patch
        ts_language_symbol_for_name: [nil], #patch
        ts_language_field_count: [nil], #patch
        ts_language_field_name_for_id: [nil], #patch
        ts_language_field_id_for_name: [nil], #patch
        ts_language_symbol_type: [nil], #patch
        ts_language_version: [nil], #patch
      }
    end
