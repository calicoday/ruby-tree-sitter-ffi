...
class RustyQuery < RustyBoss
  ...
  # let all pass for finding still problems
    ...
    # new in 0.20.7:
		when "test_query_sibling_patterns_dont_match_children_of_an_error" then nil
    ...
    # new in 0.20.7:
		when "test_query_matches_with_wildcard_at_root_intersecting_byte_range" then nil
    ...
    # new in 0.20.7:
		when "test_query_captures_with_matches_removed_before_they_finish" then nil
		...
		### gone: when "test_query_step_is_definite" then nil
		# new in 0.20.7:
		when "test_query_random" then nil
		# new in 0.20.7:
		when "test_query_is_pattern_guaranteed_at_step" then nil
		# new in 0.20.7:
		when "test_query_is_pattern_rooted" then nil
		# new in 0.20.7:
		when "test_capture_quantifiers" then nil
...
# 		when "test_query_matches_with_unrooted_patterns_intersecting_byte_range" then nil
    ...
    # new in 0.20.7:
		when "test_query_matches_with_wildcard_at_root_intersecting_byte_range" then "choke, noVec"
  # bad end ### is it???!!!
...
# 		when "test_query_captures_with_definite_pattern_containing_many_nested_matches" then nil
    ...
    # new in 0.20.7:
		when "test_query_captures_with_matches_removed_before_they_finish" then 'bc if text == "as"'
...
# 		when "test_query_alternative_predicate_prefix" then nil
		...
		### gone: when "test_query_step_is_definite" "bc why???!!!"
		# new in 0.20.7:
		when "test_query_random" then 'bc for i in 0..100'
		# new in 0.20.7:
		when "test_query_is_pattern_guaranteed_at_step" then 'bc rustiness'
		# new in 0.20.7:
		when "test_query_is_pattern_rooted" then 'bc rustiness'
		# new in 0.20.7:
		when "test_capture_quantifiers" then 'bc rustiness'
