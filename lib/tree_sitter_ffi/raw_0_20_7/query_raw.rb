...
module TreeSitterFFI
  class Query < BossFFI::BossPointer
    ...
    wrap_attach(TreeSitterFFI, :ts_query_, [
      ...
      [:ts_query_is_pattern_rooted, [Query, :uint32_t], :bool],
      [:ts_query_is_pattern_guaranteed_at_step, [Query, :uint32_t], :bool],
      [:ts_query_capture_name_for_id, [Query, :uint32_t, :uint32_t_p], :string],
      [:ts_query_capture_quantifier_for_id, [Query, :uint32_t, :uint32_t], EnumQuantifier],
    ...
    # @param [:uint32_t] uint32_t_1 
    # @return [:bool] 
    def is_pattern_rooted(uint32_t_1)
      TreeSitterFFI.ts_query_is_pattern_rooted(self, uint32_t_1)
    end
  
    # @param [:uint32_t] uint32_t_1 
    # @return [:bool] 
    def is_pattern_guaranteed_at_step(uint32_t_1)
      TreeSitterFFI.ts_query_is_pattern_guaranteed_at_step(self, uint32_t_1)
    end
    ...
    # @return [EnumQuantifier] 
    def capture_quantifier_for_id(uint32_t_1, uint32_t_2)
      TreeSitterFFI.ts_query_capture_quantifier_for_id(self, uint32_t_1, uint32_t_2)
    end
