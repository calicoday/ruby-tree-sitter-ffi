...
module TreeSitterFFI
  class Tree < BossFFI::BossPointer
    ...
    wrap_attach(TreeSitterFFI, :ts_tree_, [
      ...
      [:ts_tree_root_node_with_offset, [Tree, :uint32_t, Point.by_value], Node.by_value],
    ...
    # @return [Node.by_value] 
    def root_node_with_offset(uint32_t_1, point_1)
      TreeSitterFFI.ts_tree_root_node_with_offset(self, uint32_t_1, point_1)
    end
